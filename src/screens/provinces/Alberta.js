...
import { transports } from '../../constants/alberta/transports';
import { foods } from '../../constants/alberta/foods';
import { real_estate } from '../../constants/alberta/real-estate';
import { rental } from '../../constants/alberta/rental';
        ...
        <ScrollView style={styles.container}>
            ...
            <View style={styles.border}>
                ...
                <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                    ...
                    <Link
                        ...
                        href='https://www.zolo.ca/alberta-real-estate'
                    >https://www.zolo.ca/
                    </Link>
            ...
            <View style={styles.border}>
                ...
                <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                    ...
                    <Link
                        _text={{ color: colors.lightblue }}
                        href='https://www.rentboard.ca/alberta'
            ...
            <View style={styles.border}>
                ...
                <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                    ...
                    <Link
                        _text={{ color: colors.lightblue }}
                        href='https://www.expatistan.com/cost-of-living/calgary'
            ...
            <View style={styles.border}>
                ...
                <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                    <Text
                        ...
                        <Link
                        _text={{ color: colors.lightblue }}
                        href='https://www.calgarytransit.com/home.html' // calgarytransit.com (maybe restric for other countries)
